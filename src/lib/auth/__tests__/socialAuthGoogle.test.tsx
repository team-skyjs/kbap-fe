...
jest.mock('@/lib/push/pushAdapter', () => ({ registerPushToken: jest.fn().mockResolvedValue(undefined), applyPendingActivityDefault: jest.fn().mockResolvedValue(undefined) })); // KB-543: 로그인 직후 토큰 등록 배선
