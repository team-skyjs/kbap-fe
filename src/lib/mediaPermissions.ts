 ...
 * - 저장(스토리 카드): Android 10+(API 29) = MediaStore 저장, 권한 불필요 · Android 9 이하 = WRITE_EXTERNAL_STORAGE
 *   (maxSdk 32로 선언 유지) · iOS = 추가 전용 권한
...
/** 사진첩 저장 전 권한 요청이 필요한가 — iOS · Android 9(API 28) 이하만. */
