/**
 * Edit my review (mockup Screen I8) — opened by tapping a card in the My reviews
 * list (KB-85). Shows the reviewed dish, the author's editable rating + text,
 * posted date, and a delete action.
 *
...
import { SubHeader, Btn, Star, RiskMark, IconCheck, IconTrash, IconChevron } from '@/components';
      ...
      <ScrollView contentContainerStyle={styles.body} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.block}>
          ...
          <View style={styles.metaRow}>
            <Text style={styles.tag}>{t('editReview.posted', { when: relativeDate(review.createdAt, t) })}</Text>
