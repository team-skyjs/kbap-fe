  ...
  return (
    <View style={[styles.root, { paddingTop: insets.top + 10, paddingBottom: bottom + 26 }]}>
      ...
      <View style={styles.foot}>
        ...
        <Pressable onPress={() => { void (async () => { await logoutLocalFirst().catch(() => {}); track(EVENTS.auth_guest_enter); setUserProps({ user_info_is_registered: false }); /* P-083+144 */ router.replace('/(tabs)' as Href); })(); }} hitSlop={8}>
